  ...
  return (
    <div className="formDiv">
      <form>
        ...
        <input type="number" min="0" max="500" id="1person" placeholder="12"></input>

        <label for="2people">Ilość 2 osobowych pokoi</label>
        <input type="number" min="0" max="500" id="2people" placeholder="42"></input>

        <label for="3people">Ilość 3 osobowych pokoi</label>
        <input type="number" min="0" max="500" id="3people" placeholder="5"></input>

        <label for="rooms">Ilość wolnych pokojów</label>
        <input type="number" min="0" max="500" id="rooms" placeholder="8"></input>
